...
VOCopts.datadir= ['/opt/data/ds/pedestrians/INRIAPerson-adapter/'];

% change this path to a writable directory for your results
VOCopts.resdir=['/opt/data/ds/pedestrians/INRIAPerson-adapter/results/test/'];

% change this path to a writable local directory for the example code
VOCopts.localdir=[ '/opt/data/ds/pedestrians/INRIAPerson-adapter/local/'];
